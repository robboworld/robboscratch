...
public class Menu extends Sprite {
        ...
        public function Menu(clientFunction:Function = null, menuName:String = '', color:int = 0xA0A0A0, itemHeight:int = 28) {
                ...
                //this.scaleX = Scratch.app.scaleX;
                //this.scaleY = Scratch.app.scaleY;


                var tfVersion:TextField = new TextField();
                tfVersion.autoSize = TextFieldAutoSize.LEFT;
                tfVersion.selectable = false;
                tfVersion.defaultTextFormat = new TextFormat(CSS.font, 10, CSS.textColor);
                tfVersion.text = '1234';
                tfVersion.x = 100;
                tfVersion.y = 10;
        ...
        public function showOnStage(stage:Stage, x:int = -1, y:int = -1):void {
                ...
                //this.x *= Scratch.app.scaleX;
                this.y *= Scratch.app.scaleY;
                stage.addChild(this);
