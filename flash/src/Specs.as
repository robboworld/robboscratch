...
public class Specs {
   ...
   //AZ
   //ScratchDuino instead of 'More Blocks'
   public static const categories:Array = [
    // id   category name  color
      ...
      [6,  "Control",      0xe1a91a],
      [7,  "Sensing",      0x2ca5e2],
      [8,  "Operators",    0x87D035],
//      [8,  "Operators",    0x2cb732],
   ...
   public static var commands:Array = [
      ...
      ["-"],
      ["turn motors on for %n secs",                      " ", 13,   "motorOnFor:elapsed:from:",                   1],
      ["turn motors on",                                  " ", 13,   "allMotorsOn",                              0.1],
      ["turn motors off",                                 " ", 13,   "allMotorsOff",                             0.1],
      ["set Robot direction %m.robotDirection",           " ", 13,   "setRobotDirection:",         "forward",    0.1],

      ["-"],

      ["turn motors on for %n steps",                     " ", 13,   "setMotionLimit:",           "10",          0.1],
      ["reset trip meters",                               " ", 13,   "resetPath"],

      ["-"],

      ["turn @turnRight %n degrees",                      " ", 13,   "turnRobotRightDegr:",                      15],
      ["turn @turnLeft %n degrees",                       " ", 13,   "turnRobotLeftDegr:",                       15],
...
//      ["Robot Bright Sensor %m.brightRobot %c",            "r", 13, "brightRobot",          "R"],
      ["Robot Bright Sensor %m.digitalRobot %m.brightRobot", "r", 13, "brightRobot",          "sensor 1", "R"],
...
//      ["motor direction %m.motorDirection", " ", 101, "setMotorDirection:",        "forward",     0.1],
      ...
      ["size",                            "r", 2, "scale"],
      ["turn Lab led %m.ledMenu on",      " ", 14, "ledOn:",                0],
      ["turn Lab led %m.ledMenu off",     " ", 14, "ledOff:",               0],
      ["turn Lab %m.ledColorMenu led on", " ", 14, "ledColorOn:",           'red'],
      ...
      ["tempo",                           "r", 3, "tempo"],
      ["play note on lab %m.noteLab",     " ", 14, "playNoteLab:",                   48, 0.1],
      ...
      ["Lab %m.analogLab",                   "r", 14, "sensorLab",             "light sensor"],
