...
//AZ
//Default category
   public function resetCategory():void { selector.select(13) }
...
//AZ Cetnral region width + 100
      paletteFrame.setWidthHeight(selector.width + 1 + 180, h - paletteFrame.y - 2); // 5
      scriptsFrame.x = selector.x + selector.width + 2 + 180;
