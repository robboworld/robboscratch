package ui.parts{
        ...
        public class LabDigitalSensorSelector extends Sprite {
           ...
           public function LabDigitalSensorSelector(app:Scratch, sensor:int) {
              this.app = app;
              this.sensor = sensor;
           ...
           private function turn(e:MouseEvent):void {
              if(dialogBox == null){
                 ...
                 dialogBox.addWidget(new LabDigitalSensorSelectorPanel(this));
