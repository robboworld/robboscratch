...
public class TopBarPart extends UIPart {
        ...
        protected var optionsMenu:IconButton;
...
/*
        public static function strings():Array {
                if(Scratch.app) {
                   ...
                   Scratch.app.showOptionsMenu(Menu.dummyButton());
...
*/
        ...
        protected function fixLayout():void {
                ...
                // add Options menu
                optionsMenu.x = nextX;
                optionsMenu.y = buttonY;
                nextX += optionsMenu.width + buttonSpace;
        ...
        protected function addTextButtons():void {
                ...
                addChild(optionsMenu = makeMenuButton('Options', app.showOptionsMenu, true));
